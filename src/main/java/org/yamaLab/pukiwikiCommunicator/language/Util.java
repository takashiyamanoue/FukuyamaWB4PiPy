...
//		  int len=x.length();
	...
	public static boolean parseLong(String x, long[] intrtn, String [] rest){
		int sign=1;
		StringBuffer ix=new StringBuffer("");
		StringBuffer xb= new StringBuffer(Util.skipSpace(x));
		char c=xb.charAt(0);
		...
		if(ix.length()>0){
		   long ixx=(new Long(ix.toString())).longValue();
		   intrtn[0]=sign*ixx;
		   rest[0]=xb.toString();
		   return true;
		}
	...
	public static long date2l(String x){
		...
		try{
		  ...
		  return date.getTime();
			...
			System.out.println("date2l format2, d="+x+" error e="+e);
		}
		try{
			  Date date = dateFormat1.parse(x);
			  return date.getTime();
				...
				System.out.println("date2l format1, d="+x+" error e="+e);
		...
		try{
			  ...
			  return date.getTime();
				...
				System.out.println("date2l format3, d="+x+" error e="+e);
...
//		System.out.println("rtn="+rtn);
	...
	public static String str2strc(String x){
		StringBuffer xb=new StringBuffer(x);
		StringBuffer ix=new StringBuffer("");
		ix.append('\"');
		int i=0;
